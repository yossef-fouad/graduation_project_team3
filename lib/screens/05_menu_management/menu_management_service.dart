...
class MenuManagementService {
  ...
  Future<void> addCategory(String name, {String? imageUrl}) async {
    await cloud.from('categories').insert({
      'name': name,
      'image_url': imageUrl,
    });
  }
  ...
  Future<void> updateCategory(
    ...
    await cloud.from('categories').update(updates).eq('id', id);
  }
  ...
  Future<void> updateIngredient(
    ...
    await cloud
        .from('ingredients')
        .update({'name': name, 'stock_level': stock, 'unit': unit})
        .eq('id', id);
  }
  ...
  Future<void> updateMealIngredients(
    String mealId,
  ...
  Future<Map<String, Map<String, num>>> getMealRatings() async {
    ...
    ratings.forEach((mealId, list) {
      ...
      result[mealId] = {'average': avg, 'count': list.length};
    });
